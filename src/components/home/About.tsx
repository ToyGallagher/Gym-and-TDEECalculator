    ...
    <section id="about" className="flex h-screen bg-[url('/Sam.jpeg')] bg-cover bg-center text-white">
      ...
      <div className="w-1/2 p-12 flex flex-col justify-center">
        ...
        <p className="text-lg mb-4">
          Im a paragraph. Click here to add your own text and edit me. Its easy. Just click “Edit Text” or double click me to add your own content and make changes to the font. Feel free to drag and drop me anywhere you like on your page. I’m a great place for you to tell a story and let your users know a little more about you.
        </p>
        <p className="text-lg">
